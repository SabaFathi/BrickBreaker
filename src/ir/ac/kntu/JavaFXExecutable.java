...
public class JavaFXExecutable extends Application {
    ...
    private final static String MAIN_MENU_BACKGROUND_ADDRESS =
            "resources\\img\\mainMenu.png";
    private final static String SOUND_ADDRESS =
            "resources\\sound\\sound1.mp3";
    private final static String SOUND_ON_ADDRESS =
            "resources\\img\\soundOn.png";
    private final static String SOUND_OFF_ADDRESS =
            "resources\\img\\soundOff.png";
    ...
    private Scene mainMenu(){
        ...
        try{
            ...
            menuImg = new FileInputStream(MAIN_MENU_BACKGROUND_ADDRESS);
        ...
        Media media = new Media(Paths.get(SOUND_ADDRESS).
    ...
    private void setUpMediaProcess(GridPane menuLayout,
        ...
        try{
            mediaOnImgVu = new ImageView(new Image(new FileInputStream(
                    Paths.get(SOUND_ON_ADDRESS).toFile())));
            mediaOffImgVu = new ImageView(new Image(new FileInputStream(
                    Paths.get(SOUND_OFF_ADDRESS).toFile())));
            final int size = 40;
